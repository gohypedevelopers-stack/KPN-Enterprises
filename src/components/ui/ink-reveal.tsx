...
interface InkRevealProps {
  /** Image URL to use as the mask overlay instead of a solid color */
  imageSrc?: string;
...
export default function InkReveal({
  ...
  const drawImageCover = useCallback((ctx: CanvasRenderingContext2D, img: HTMLImageElement, w: number, h: number) => {
  ...
  }, [carveInk, mc, lifetime, rStart, imageSrc, drawImageCover]);
